      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-950 border border-gray-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl">Programador de Videos</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="rounded border-gray-700 bg-gray-950" />
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-900 text-gray-400">O continuar con</span>
            </div>
          </div>
