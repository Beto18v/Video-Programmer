...
export function RegisterPage({ onNavigate }: RegisterPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-red-950/20 via-transparent to-transparent"></div>
      
      <div className="w-full max-w-md relative">
        <Button
          variant="ghost"
          onClick={() => onNavigate('landing')}
          className="mb-8 hover:bg-gray-800"
        >
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-950 border border-gray-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Comienza gratis hoy</p>
            </div>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="text-sm text-gray-400">
              <label className="flex items-start gap-2 cursor-pointer">
                <input type="checkbox" className="mt-1 rounded border-gray-700 bg-gray-950" required />
                <span>
                  Acepto los{' '}
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-900 text-gray-400">O regístrate con</span>
            </div>
          </div>
