                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                se te pedirá un PIN seguro y aleatorio durante
                                el inicio de sesión, que puedes recuperar de la
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                inicio de sesión. Este PIN se puede recuperar de
                                una aplicación compatible con TOTP en tu
                                teléfono.
                            </p>
