...
export default function VideoSchedulesEdit({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Editar Programación de Vídeo" />
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                ...
                <Card className="max-w-2xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Actualizar los detalles de la programación
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="grid gap-2">
                            ...
                            <Select
                                name="video_id"
                                defaultValue={videoSchedule.video_id.toString()}
                            >
                                <SelectTrigger>
                        ...
                        <div className="grid gap-2">
                            ...
                            <Select
                                name="action"
                                defaultValue={videoSchedule.action}
                            >
                                <SelectTrigger>
                                    <SelectValue />
                                </SelectTrigger>
